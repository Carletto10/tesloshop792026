...
@Component({
  selector: 'router-appRoute',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './router-appRoute-component.html',
  styleUrl: './router-appRoute-component.css'
})
export class RouteAppRouteComponent {
  expectedOrder = ['export const routes: Routes', '{path : "secondRoute"', 'loadComponent : () =>', 'import("./test.component")', '.then( m => m.TestComponent)'];
  codeExample = "export const routes: Routes = [{path : 'secondRoute',loadComponent : () => import('./test.component').then( m => m.TestComponent)}";
